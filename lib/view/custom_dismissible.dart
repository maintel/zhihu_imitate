...
class _DismissibleState extends State<MyDismissible> with TickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  @override
  void initState() {
    super.initState();
    ...
    if (_directionIsXAxis) {
      switch (Directionality.of(context)) {
        case TextDirection.rtl:
          return extent < 0 ? MyDismissDirection.startToEnd : MyDismissDirection.endToStart;
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.secondaryBackground != null) {
      final MyDismissDirection direction = _dismissDirection;
      if (direction == MyDismissDirection.endToStart || direction == MyDismissDirection.up)
